...
import reciclaje from '../../../../assets/styles/images/reciclaje.png';
import flor from '../../../../assets/styles/images/flor.png';
import usuario from '../../../../assets/styles/images/usuario.png';
import icemail from '../../../../assets/styles/images/ic-email.png';
import icdireccion from '../../../../assets/styles/images/ic-direccion.png';
import ictelefono from '../../../../assets/styles/images/ic-telefono.png';
import iccedula from '../../../../assets/styles/images/ic-cedula.png';
import icuser from '../../../../assets/styles/images/ic-user.png';
            ...
            <div class="perfil-hero__left">
              ...
              <div id="perfil-display-mode" style="display: ${isEditing ? 'none' : 'block'};">
                <div class="perfil-info-list">
                  ...
                  <div class="perfil-info-item">
                    <div class="perfil-info-item__icon">
                      <img src=${ictelefono} alt="Teléfono">
                    </div>
                  ...
                  <div class="perfil-info-item">
                    <div class="perfil-info-item__icon">
                      <img src=${icdireccion} alt="Dirección">
                    </div>
            ...
            <div class="perfil-hero__right">
              ...
              <div class="perfil-points-badge">
                <div class="perfil-points-badge__flower">
                  <img src=${flor} alt="Flor" style="width: 100%; height: 100%; object-fit: contain;">
                </div>
            ...
            <div class="perfil-impacto__content">
              ...
              <div class="perfil-impacto__body">
                ...
                <div class="perfil-impacto__icon">
                  <img src=${reciclaje} alt="Reciclaje">
                </div>
              </div>
            </div>
